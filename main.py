...
def get_instagram_followers(username):
    ...
    try:
        ...
        print(f"Instagram verisi çekilemedi ({username}): {e}")
        return None
...
def main():
    ...
    if current_followers is None:
        print("❌ Takipçi sayısı çekilemedi. İstek engellenmiş veya kullanıcı bulunamamış olabilir.")
        # Dosya yoksa git hatasını önlemek için boş/varsayılan dosya oluştur
